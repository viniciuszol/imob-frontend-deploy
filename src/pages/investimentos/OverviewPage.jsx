...
export default function OverviewPage() {
    ...
    // 🔥 FILTRA APENAS ATIVOS COM TOTAL >= 0
    const ativosPositivos = overview.ativos.filter((a) => Number(a.total) >= 0);
        ...
        <div>
            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white flex flex-col items-center">
                <main className="px-8 py-10 w-full max-w-7xl">
                    ...
                    {/* FILTROS */}
                    {enums && (
                        <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 mb-10">
                            {Object.entries(enums).map(([key, list]) => (
                                <select
                                    ...
                                    onChange={(e) =>
                                        carregarOverview({ [key]: e.target.value })
                                    }
                                >
                                    <option value="">Todos ({formatEnum(key)})</option>
                                    {list.map((item) => (
                    ...
                    <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-6 shadow-lg w-full">
                        ...
                        {/* 🧩 CONTAINER FLEX (GRÁFICO + LEGENDA) */}
<div className="flex flex-row gap-6 max-h-[600px]">

    {/* 🎯 GRÁFICO — ESQUERDA (diminuído p/ caber mais legenda) */}
                ...
                datasets: [
                    {
                        ...
                        backgroundColor: COLORS.slice(0, ativosPositivos.length),
                        borderColor: "#0000",
                    },
                ],
            }}
    ...
    {/* 🟩 LEGENDA — DIREITA com SCROLL */}
    <div className="w-1/2 flex flex-col gap-3 overflow-y-auto pr-2">

        <h3 className="text-lg font-semibold mb-1">Legenda</h3>
